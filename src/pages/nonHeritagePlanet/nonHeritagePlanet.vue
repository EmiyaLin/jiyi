  ...
  <div>
    ...
    <div class="banner">
      <Carousel3d
        ...
        :controls-prev-html="`<div style='background-color: #b7474e; margin-left: 10px; height: 300px; display: flex; align-items: center; justify-content: center; margin: -100px 10px;'><img src='${require('../../assets/img1/home/arrow_left.png')}' alt='' /></div>`"
        :controls-next-html="`<div style='background-color: #b7474e; margin-left: 10px; height: 300px; display: flex; align-items: center; justify-content: center; margin: -100px 10px;'><img src='${require('../../assets/img1/home/arrow_right.png')}' alt='' /></div>`"
        :space="220"
        :border-radius="10"
        :border="0"
        :height="475"
          ...
          <div class="slide1" style="display: flex">
            ...
            >
              <div class="title" style="display: flex; flex-direction: column">
                <img
                  src="../../assets/img1/home/arrow_up.png"
                  alt=""
                  style="margin-bottom: 30px"
                />
                <p style="width: 10px">{{ slide.title }}</p>
                <img
                  src="../../assets/img1/home/arrow_down.png"
                  alt=""
    ...
    <div class="story2">
      <div class="title2Content">
        <img src="../../assets/img1/home/arrow_up.png" alt="" />
        <p class="">合作非遗传承人</p>
        <img src="../../assets/img1/home/arrow_down.png" alt="" />
      </div>
      <carousel
      ...
      slides: [
        {
          ...
          imgUrl: require("../../assets/img1/nonheritage_planet/fxr.png"),
        },
        {
          title: "剪纸",
          detail: "独特手工技艺 ，悠久历史传承",
          imgUrl: require("../../assets/img1/nonheritage_planet/jianzhi.png"),
        },
        {
          title: "皮影戏",
          detail: "独特手工技艺 ，悠久历史传承",
          imgUrl: require("../../assets/img1/nonheritage_planet/piyingxi.png"),
        },
        {
          title: "傩戏",
          detail: "独特手工技艺 ，悠久历史传承",
          imgUrl: require("../../assets/img1/nonheritage_planet/nuoxi.png"),
        },
        {
          title: "榫卯结构",
          detail: "独特手工技艺 ，悠久历史传承",
          imgUrl: require("../../assets/img1/nonheritage_planet/sunmao.png"),
        },
      ],
      storyContent: [
        {
          imgUrl:
            require("../../assets/img1/nonheritage_planet/ccr1.png"),
          title: "",
          content: "",
          hoverImgUrl: "",
        },
        {
          imgUrl:
            require("../../assets/img1/nonheritage_planet/ccr2.png"),
          title: "",
          content: "",
          hoverImgUrl: "",
        },
        {
          imgUrl:
            require("../../assets/img1/nonheritage_planet/ccr3.jpeg"),
          title: "",
          content:
            "陈慧敏\n出身陶瓷世家，祖上数辈都曾从事陶瓷烧制工作,\n师从许家有、熊忠贵两位匠人，勤学苦练建盏烧制技艺",
          hoverImgUrl: require("../../assets/img1/nonheritage_planet/ccr3.png"),
        },
        {
          imgUrl: require("../../assets/img1/nonheritage_planet/ccr4.png"),
          title: "",
          content: "",
          hoverImgUrl: "",
        },
        {
          imgUrl: require("../../assets/img1/nonheritage_planet/ccr5.png"),
          title: "",
          content: "",
          hoverImgUrl: "",
        },
...
.banner {
  padding-top: 80px;
  background-image: url("../../assets/img1/nonheritage_planet/background.png");
}
...
.description {
  ...
  background-image: linear-gradient(
    ...
    url("../../assets/img1/nonheritage_planet/fxr_backgrounnd.png");
...
.story2 {
  ...
  background-image: url("https://img.js.design/assets/img/660c0e22fa7de412e22092eb.png");
